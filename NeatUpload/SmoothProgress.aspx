      ...
      <tr>
        ...
        <td id="barTd">
          <div id="statusDiv" runat="server" class="StatusMessage">
            ...
            <Upload:DetailsDiv ID="barDetailsDiv" runat="server" UseHtml4="true" FractionComplete='<%# FractionComplete %>' Status='<%# Status %>' Width='<%# Unit.Percentage(Math.Floor(100*FractionComplete)) %>' CssClass="ProgressBar"></Upload:DetailsDiv>
          </div>
        </td>
        <td>
